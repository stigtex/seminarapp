...
public class UpdateSeminarEndpoint  : Endpoint<UpdateSeminarRequest, SeminarResponse>
{
    ...
    public override async Task HandleAsync(UpdateSeminarRequest req, CancellationToken ct)
    {
