...
public class GetParticipantEndpoint : Endpoint<GetParticipant, ParticipantResponse>
{   
    ...
    public override async Task HandleAsync(GetParticipant req, CancellationToken ct)
    {
